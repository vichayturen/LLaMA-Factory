...
from trl_main import apply_chat_template
...
```python
from datasets import Dataset
from trl_main import extract_prompt
...
```python
from datasets import Dataset
from trl_main import extract_prompt, unpair_preference_dataset
...
```python
from datasets import Dataset
from trl_main import unpair_preference_dataset

...
from datasets import load_dataset
from trl_main import SFTConfig, SFTTrainer, DataCollatorForCompletionOnlyLM
...
```python
from transformers import AutoModelForCausalLM, AutoTokenizer
from trl_main import setup_chat_format
...
```python
from trl_main import ModelConfig, SFTTrainer, get_kbit_device_map, get_peft_config, get_quantization_config
